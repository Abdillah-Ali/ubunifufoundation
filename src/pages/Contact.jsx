            ...
            {contactInfo.map((item) => (
              <div key={item.title} className="space-y-6 group reveal">
                ...
                <div className="space-y-2">
                  <h3 className="text-[20px] md:text-[24px] font-medium tracking-tight font-serif">{item.title}</h3>
                  {item.lines.map((line) => (
                    <p key={line} className="text-base text-foreground font-normal font-sans leading-[22px]">{line}</p>
                  ))}
                </div>
              </div>
            ))}
          ...
          <div className="grid lg:grid-cols-2 gap-24 xl:gap-32">
            ...
            <div className="space-y-12 reveal max-w-xl w-full mx-auto lg:mx-0">
              <div className="space-y-4">
                ...
                <h2 className="text-[34px] md:text-[42px] font-medium tracking-tight font-serif">Send a Message</h2>
              </div>
              
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid sm:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    <label className="text-[14px] font-normal tracking-[0.75px] text-foreground ml-6 uppercase font-sans">Full Name</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-[14px] font-normal tracking-[0.75px] text-foreground ml-6 uppercase font-sans">Email Address</label>
                ...
                <div className="grid sm:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    <label className="text-[14px] font-normal tracking-[0.75px] text-foreground ml-6 uppercase font-sans">Phone Number</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-[14px] font-normal tracking-[0.75px] text-foreground ml-6 uppercase font-sans">Subject</label>
                ...
                <div className="space-y-2">
                    <label className="text-[14px] font-normal tracking-[0.75px] text-foreground ml-6 uppercase font-sans">Message</label>
            ...
            <div className="space-y-12 reveal">
              <div className="space-y-4">
                ...
                <h2 className="text-[34px] md:text-[42px] font-medium tracking-tight font-serif">Our <span className="text-primary">Space.</span></h2>
              </div>
              ...
              <div className="rounded-[4rem] bg-secondary aspect-square lg:aspect-[4/3] flex items-center justify-center border border-border shadow-2xl relative overflow-hidden group">
                ...
                <div className="relative z-10 p-10 text-white space-y-4 text-center">
                  ...
                  <div>
                    <p className="text-[20px] md:text-[24px] font-medium tracking-tight font-serif">Main Headquarters</p>
                    <p className="text-[14px] font-normal text-white font-sans tracking-[0.75px]">Zanzibar, Tanzania</p>
                  </div>
                </div>
              </div>
