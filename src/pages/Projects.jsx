      ...
      <section className="relative pt-32 pb-24 bg-[#001D3D] text-white overflow-hidden">
        ...
        <Container className="relative z-10">
          <div className="max-w-4xl space-y-6 reveal">
            <span className="text-metadata uppercase text-primary/80">
              Our Portfolios
            </span>
            <h1 className="text-[40px] md:text-[64px] font-medium leading-[1.1] tracking-tight font-serif">
              Programs & <span className="text-primary italic">Initiatives.</span>
            </h1>
            <p className="text-[16px] text-white/80 max-w-2xl font-normal leading-[22px] font-sans">
        ...
        <Container>
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-20 reveal">
            <div className="max-w-2xl space-y-6">
              <h2 className="text-[24px] font-medium text-body font-serif leading-[32px]">
                Catalyzing Change.
              </h2>
              <p className="text-[16px] text-body leading-[22px] font-sans">
            ...
            <div className="flex flex-wrap gap-6">
              <div className="space-y-3">
                <p className="text-metadata uppercase ml-4">Type</p>
              ...
              <div className="space-y-3">
                <p className="text-metadata uppercase ml-4">Status</p>
                <div className="flex bg-slate-50 p-1.5 rounded-full border border-slate-100">
              ...
              <div key={project.id} className="group reveal flex flex-col h-full">
                ...
                <div className="relative aspect-[16/11] rounded-[2rem] overflow-hidden shadow-sm border border-slate-100 mb-8">
                  ...
                  <div className="absolute top-6 left-6">
                    <span className={cn(
                      "px-4 py-1.5 rounded-full text-metadata uppercase shadow-lg",
                      project.type === "program" ? "bg-primary text-white" : "bg-white text-body"
                    )}>
                      {project.type}
                    </span>
                  </div>
                ...
                <div className="space-y-4 flex-1 flex flex-col">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-metadata uppercase">{project.status}</span>
                  </div>
                  <h3 className="text-[24px] font-medium text-body font-serif leading-[32px] group-hover:text-primary transition-colors">
                    {project.title}
                  </h3>
                  <p className="text-[16px] text-body leading-[22px] font-sans line-clamp-3">
                    {project.description}
                  </p>
        ...
        <Container>
          <div className="bg-[#001D3D] rounded-[3rem] p-12 md:p-20 text-center space-y-10 relative overflow-hidden reveal">
            ...
            <div className="max-w-3xl mx-auto space-y-6 relative z-10">
              <h2 className="text-[32px] md:text-[48px] font-medium text-white font-serif leading-tight">
                Have a project idea? <br /> <span className="text-primary italic">Let's collaborate.</span>
              </h2>
              <p className="text-[16px] text-white/70 font-sans leading-[22px]">
